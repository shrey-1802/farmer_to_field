...
class Farm(Base):
    ...
    pincode = Column(String(10), nullable=True, doc="Indian 6-digit postal code")
...
class Field(Base):
    ...
    orientation = Column(String(50), nullable=True, default="Full Field", doc="Field side/zone orientation: North, South, East, West, Center")
    soil_type = Column(String(100), nullable=True, default="Loamy")
